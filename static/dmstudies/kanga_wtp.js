...
var drawTriviaDisplay = function(trialVariables) {
	...
	payRect.showRect(canvas.width/2, canvas.height/2 + canvas.height/5, WHITE, canvas.width * 0.2, fontSize);
	...
	payText.showText(0, canvas.height/2 + canvas.height/5 + fontSize - fontSize*0.1, fontSize);
