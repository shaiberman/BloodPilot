  ...
  plugin.info = {
    ...
    parameters: {  // Define all input parameters and their corresponding default values
      ...
      onset_delay:{
        ...
        default: [200,200,400],//[400,400,800], // drawn randomly from truncated exponential distribution with [mu, lowB, upB]
        array: true,
      ...
      feedback_dur:{ // for warning messages in miss trials
        ...
        default: 500, // amx changed from 750 to 500
      ...
      error_timeout:{ // extra delay after errors/misses (in addition to feedback duration)
        ...
        default: 500, // amx changed from 1750 to 500
      ...
      function stateProcess() {
        ...
        switch (State.Current) {
          ...
          case State.MAPPING: // show mapping on screen
            if (State.Time > 500) { // ITI duration - amx
          ...
          case State.DELAY:
              ...
              if (data.RT < 100) { // if RT < 100 ms, count as too early
                ...
                if (data.accuracy) {
    				      feedbackText = 'Correct';//n''(+1)';
    				      feedbackCol = 'green';
    				    } else {
    				      feedbackText = 'Wrong';//n(-1)';
    				      feedbackCol = 'red';
    				    }
    		  ...
    		  case State.FEEDBACK: 
    		    ...
    		    // commented by amx if ((data.accuracy & State.Time > trial.feedback_dur) || ((!data.accuracy || data.missTrial) & State.Time > (trial.feedback_dur+trial.error_timeout))) { // after feedback duration, remove feedback
    		    if ((State.Time > trial.feedback_dur) || ((data.missTrial) & State.Time > (trial.feedback_dur+trial.error_timeout))) { // after feedback duration, remove feedback
    		      feedbackText = '';
